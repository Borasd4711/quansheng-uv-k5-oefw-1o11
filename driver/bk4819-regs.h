...
#define BK4819_REG_02_SHIFT_INTERRUPT_STATUS    	0
...
#define BK4819_REG_02_MASK_INTERRUPT_STATUS			(1U << BK4819_REG_02_SHIFT_INTERRUPT_STATUS)
...
#define BK4819_REG_02__INTERRUPT_STATUS			(1U << BK4819_REG_02_SHIFT_INTERRUPT_STATUS)
...
#define BK4819_REG_3F_MASK_FSK_TX_FINISHED			(1U << BK4819_REG_3F_SHIFT_FSK_TX_FINISHED)
...
#define BK4819_REG_58_SHIFT_FSK_TX_MODE 13
#define BK4819_REG_58_SHIFT_FSK_RX_MODE 10
#define BK4819_REG_58_SHIFT_FSK_RX_GAIN 8
#define BK4819_REG_58_SHIFT_FSK_UNKNOWN 6
#define BK4819_REG_58_SHIFT_FSK_PREAMBLE_TYPE 4
#define BK4819_REG_58_SHIFT_FSK_RX_BANDWIDTH 1
#define BK4819_REG_58_SHIFT_FSK_ENABLE 0

#define BK4819_REG_58_MASK_FSK_TX_MODE       (0x7u << BK4819_REG_58_SHIFT_FSK_TX_MODE)
#define BK4819_REG_58_MASK_FSK_RX_MODE       (0x7u << BK4819_REG_58_SHIFT_FSK_RX_MODE)
#define BK4819_REG_58_MASK_FSK_RX_GAIN       (0x3u << BK4819_REG_58_SHIFT_FSK_RX_GAIN)
#define BK4819_REG_58_MASK_FSK_UNKNOWN       (0x3u << BK4819_REG_58_SHIFT_FSK_UNKNOWN) // in LVG github code we find '0b11'
#define BK4819_REG_58_MASK_FSK_PREAMBLE_TYPE (0x3u << BK4819_REG_58_SHIFT_FSK_PREAMBLE_TYPE)
#define BK4819_REG_58_MASK_FSK_RX_BANDWIDTH  (0x7u << BK4819_REG_58_SHIFT_FSK_RX_BANDWIDTH)
#define BK4819_REG_58_MASK_FSK_ENABLE        (1u << BK4819_REG_58_SHIFT_FSK_ENABLE)

enum {
	BK4819_REG_58_FSK_TX_MODE_FSK1200_FSK2400 = (0 << BK4819_REG_58_SHIFT_FSK_TX_MODE),
	BK4819_REG_58_FSK_TX_MODE_FFSK1200_1800   = (0x1u << BK4819_REG_58_SHIFT_FSK_TX_MODE),
	BK4819_REG_58_FSK_TX_MODE_FFSK1200_2400   = (0x3u << BK4819_REG_58_SHIFT_FSK_TX_MODE),
	BK4819_REG_58_FSK_TX_MODE_NOAA   		  = (0x5u << BK4819_REG_58_SHIFT_FSK_TX_MODE),

	BK4819_REG_58_FSK_RX_MODE_FSK1200_FSK2400_NOAA = (0 << BK4819_REG_58_SHIFT_FSK_TX_MODE),
	BK4819_REG_58_FSK_RX_MODE_FFSK1200_1800        = (0x7u << BK4819_REG_58_SHIFT_FSK_TX_MODE),
	BK4819_REG_58_FSK_RX_MODE_FFSK1200_2400        = (0x4u << BK4819_REG_58_SHIFT_FSK_TX_MODE),

	BK4819_REG_58_FSK_RX_GAIN_0         = (0 << BK4819_REG_58_SHIFT_FSK_RX_GAIN),
	BK4819_REG_58_FSK_RX_GAIN_1         = (0x1u << BK4819_REG_58_SHIFT_FSK_RX_GAIN),
	BK4819_REG_58_FSK_RX_GAIN_2         = (0x2u << BK4819_REG_58_SHIFT_FSK_RX_GAIN),
	BK4819_REG_58_FSK_RX_GAIN_3         = (0x3u << BK4819_REG_58_SHIFT_FSK_RX_GAIN),

	BK4819_REG_58_FSK_PREAMBLE_TYPE_0xAA         = (0x3u << BK4819_REG_58_SHIFT_FSK_PREAMBLE_TYPE),
	BK4819_REG_58_FSK_PREAMBLE_TYPE_0x55         = (0x2u << BK4819_REG_58_SHIFT_FSK_PREAMBLE_TYPE),
	BK4819_REG_58_FSK_PREAMBLE_TYPE_0xAA_OR_0x55 = (0 << BK4819_REG_58_SHIFT_FSK_PREAMBLE_TYPE),	// depending on MSB

	BK4819_REG_58_FSK_RX_BANDWIDTH_FSK2400_OR_FFSK1200_2400 = (0x4u << BK4819_REG_58_SHIFT_FSK_RX_BANDWIDTH),
	BK4819_REG_58_FSK_RX_BANDWIDTH_FSK1200                  = (0 << BK4819_REG_58_SHIFT_FSK_RX_BANDWIDTH),
	BK4819_REG_58_FSK_RX_BANDWIDTH_FFSK1200_1800            = (0x1u << BK4819_REG_58_SHIFT_FSK_RX_BANDWIDTH),
	BK4819_REG_58_FSK_RX_BANDWIDTH_NOAA                     = (0x2u << BK4819_REG_58_SHIFT_FSK_RX_BANDWIDTH),

	BK4819_REG_58_FSK_ENABLE  = (1u << BK4819_REG_58_SHIFT_FSK_ENABLE),
	BK4819_REG_58_FSK_DISABLE = (0 << BK4819_REG_58_SHIFT_FSK_ENABLE),
};

// REG 59

#define BK4819_REG_59_SHIFT_FSK_CLEAR_TX_FIFO 15
#define BK4819_REG_59_SHIFT_FSK_CLEAR_RX_FIFO 14
#define BK4819_REG_59_SHIFT_FSK_SCRAMBLE 13
#define BK4819_REG_59_SHIFT_FSK_ENABLE_RX 12
#define BK4819_REG_59_SHIFT_FSK_ENABLE_TX 11
#define BK4819_REG_59_SHIFT_FSK_INVERT_WHEN_RX 10
#define BK4819_REG_59_SHIFT_FSK_INVERT_WHEN_TX 9
#define BK4819_REG_59_SHIFT_FSK_PREAMBLE_LENGTH 4
#define BK4819_REG_59_SHIFT_FSK_SYNC_LENGTH 3

#define BK4819_REG_59_MASK_FSK_CLEAR_TX_FIFO   (1u << BK4819_REG_59_SHIFT_FSK_CLEAR_TX_FIFO)
#define BK4819_REG_59_MASK_FSK_CLEAR_RX_FIFO   (1u << BK4819_REG_59_SHIFT_FSK_CLEAR_RX_FIFO)
#define BK4819_REG_59_MASK_FSK_SCRAMBLE        (1u << BK4819_REG_59_SHIFT_FSK_SCRAMBLE)
#define BK4819_REG_59_MASK_FSK_ENABLE_RX       (1u << BK4819_REG_59_SHIFT_FSK_ENABLE_RX)
#define BK4819_REG_59_MASK_FSK_ENABLE_TX       (1u << BK4819_REG_59_SHIFT_FSK_ENABLE_TX)
#define BK4819_REG_59_MASK_FSK_INVERT_WHEN_RX  (1u << BK4819_REG_59_SHIFT_FSK_INVERT_WHEN_RX)
#define BK4819_REG_59_MASK_FSK_INVERT_WHEN_TX  (1u << BK4819_REG_59_SHIFT_FSK_INVERT_WHEN_TX)
#define BK4819_REG_59_MASK_FSK_PREAMBLE_LENGTH (0xFu << BK4819_REG_59_SHIFT_FSK_PREAMBLE_LENGTH)
#define BK4819_REG_59_MASK_FSK_SYNC_LENGTH     (1u << BK4819_REG_59_SHIFT_FSK_SYNC_LENGTH)

enum {
	BK4819_REG_59_FSK_ENABLE_SCRAMBLE  = (1U << BK4819_REG_59_SHIFT_FSK_SCRAMBLE),
	BK4819_REG_59_FSK_DISABLE_SCRAMBLE = (0u << BK4819_REG_59_SHIFT_FSK_SCRAMBLE),
};

// REG 5A

#define BK4819_REG_5A_SHIFT_FSK_SYNC_BYTE0 8 // default: 0x85
#define BK4819_REG_5A_SHIFT_FSK_SYNC_BYTE1 0 // default: 0xCF

#define BK4819_REG_5A_MASK_FSK_SYNC_BYTE0      (0xFFu << BK4819_REG_5A_SHIFT_FSK_SYNC_BYTE0)
#define BK4819_REG_5A_MASK_FSK_SYNC_BYTE1      (0xFFu << BK4819_REG_5A_SHIFT_FSK_SYNC_BYTE1)

// REG 5B

#define BK4819_REG_5B_SHIFT_FSK_SYNC_BYTE2 8 // default: 0xAB
#define BK4819_REG_5B_SHIFT_FSK_SYNC_BYTE3 0 // default: 0x45

#define BK4819_REG_5B_MASK_FSK_SYNC_BYTE2      (0xFFu << BK4819_REG_5B_SHIFT_FSK_SYNC_BYTE2)
#define BK4819_REG_5B_MASK_FSK_SYNC_BYTE3      (0xFFu << BK4819_REG_5B_SHIFT_FSK_SYNC_BYTE3)

// REG 5C

#define BK4819_REG_5C_SHIFT_FSK_CRC 6

#define BK4819_REG_5C_MASK_FSK_CRC      (1u << BK4819_REG_5C_SHIFT_FSK_CRC)
#define BK4819_REG_5C_MASK_FSK_UNKNOWN	0xAA30 // this value comes from BK4819_PlayRogerMDC()
//#define BK4819_REG_5C_MASK_FSK_UNKNOWN	0x5625 // this value comes from RF_EnterFsk()

enum {
	BK4819_REG_5C_FSK_ENABLE_CRC  = (1U << BK4819_REG_5C_SHIFT_FSK_CRC),
	BK4819_REG_5C_FSK_DISABLE_CRC = (0u << BK4819_REG_5C_SHIFT_FSK_CRC),
};

// REG 5D

#define BK4819_REG_5D_SHIFT_FSK_DATA_LENGTH_LOW 8
#define BK4819_REG_5D_SHIFT_FSK_DATA_LENGTH_HIGH 5

#define BK4819_REG_5D_MASK_FSK_DATA_LENGTH_LOW  (0xFFu << BK4819_REG_5D_SHIFT_FSK_DATA_LENGTH_LOW)
#define BK4819_REG_5D_MASK_FSK_DATA_LENGTH_HIGH (0x7u << BK4819_REG_5D_SHIFT_FSK_DATA_LENGTH_HIGH)

// REG 5E

#define BK4819_REG_5E_SHIFT_FSK_TX_FIFO_THRESHOLD 3 // 128 words (256 bytes) total, default: 64
#define BK4819_REG_5E_SHIFT_FSK_RX_FIFO_THRESHOLD 0 // 8 words (16 bytes) total, default: 4

#define BK4819_REG_5E_MASK_FSK_TX_FIFO_THRESHOLD      (0x7Fu << BK4819_REG_5E_SHIFT_FSK_TX_FIFO_THRESHOLD)
#define BK4819_REG_5E_MASK_FSK_RX_FIFO_THRESHOLD      (0x7u << BK4819_REG_5E_SHIFT_FSK_RX_FIFO_THRESHOLD)
